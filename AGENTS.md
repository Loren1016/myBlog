...
此文件为 Codex (Codex.ai/code) 提供当前仓库的开发指引。
...
此项目使用 Next.js **16.2.6**，与旧版本存在破坏性变更。在编写任何 Next.js 代码之前，先查阅 `frontend/node_modules/next/dist/docs/` 中的最新 API 文档。`frontend/AGENTS.md` 和 `frontend/AGENTS.md` 均对此有提醒。
